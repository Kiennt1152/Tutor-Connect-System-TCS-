...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendRegistrationOtp(String toEmail, String fullName, String code, long expireMinutes) {
        try {
            ...
            helper.setText(buildHtml(fullName, code, expireMinutes), true);
            ...
            throw new IllegalStateException("Không gửi được email xác thực. Vui lòng thử lại sau.");
        }
    }

    private String buildHtml(String fullName, String code, long expireMinutes) {
        ...
        return """
                ...
                border:1px solid #e2e8f0;border-radius:16px;overflow:hidden">
                  ...
                  <div style="padding:28px 24px;color:#0f172a">
                    ...
                    <p style="margin:0 0 16px">Cảm ơn bạn đã đăng ký tài khoản. Vui lòng sử dụng mã \
                OTP bên dưới để hoàn tất xác thực:</p>
                ...
                """.formatted(safeName, code, expireMinutes);
    }
}
