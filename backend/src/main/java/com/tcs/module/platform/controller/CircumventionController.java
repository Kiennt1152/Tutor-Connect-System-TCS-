...
/**
 * ============================================================================
 * [BF-10] [UC-59] PHÂN HỆ GIÁM SÁT & PHÁT HIỆN HÀNH VI LÁCH SÀN (CIRCUMVENTION CONTROLLER)
 * ============================================================================
 * Tác giả       : mduc1011-swp (Hoàng Minh Đức - HE187354)
 * Ngày tạo      : 2026-07-29
 * * 1. Mục đích & Chức năng:
 *   - Lách sàn (Platform Circumvention): Hành vi chia sẻ số điện thoại, tài khoản ngân hàng, link mạng xã hội nhằm trốn phí sàn hoặc bỏ qua bảo vệ Escrow.
 *   - Tự động quét và phát hiện các dấu hiệu vi phạm qua quy tắc đối sánh từ khóa và regex.
 *   - Quản trị viên duyệt sự kiện vi phạm, đóng băng tiền hoặc ban hành án phạt tương ứng.
 * * 2. Luồng xử lý chính:
 *   - Bước 1: Tiếp nhận các sự kiện vi phạm được ghi nhận tự động từ ChatService.
 *   - Bước 2: Hiển thị bằng chứng đoạn hội thoại vi phạm để Admin thẩm định.
 *   - Bước 3: Admin đưa ra quyết định xử lý (Bỏ qua hoặc Xác nhận vi phạm để ban hành chế tài).
 * ============================================================================
 */
@RestController
