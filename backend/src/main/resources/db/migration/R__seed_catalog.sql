...
INSERT INTO contract_templates (name, content, contract_type, created_by, center_id, is_default, status, created_at, updated_at)
...
-- =====================================================================
-- Core System FAQ Knowledge Base (205 Comprehensive Entries)
-- =====================================================================
...
(58, 'Xem chi tiết bằng cấp và video giới thiệu của gia sư ở đâu?', 'Bấm trực tiếp vào ảnh hoặc tên gia sư tại trang tìm kiếm /find-tutor để xem trang thông tin chi tiết cá nhân đầy đủ.', 'MARKETPLACE', 58, 1),
...
(209, 'Tìm gia sư dạy kèm tiền tiểu học (hành trang vào lớp 1, tập đọc, tập viết, làm quen số)?', 'Bạn vào mục /find-tutor, chọn khối lớp "Tiền tiểu học (Hành trang lớp 1)" để tìm các gia sư Sư phạm Giáo dục Tiểu học có chuyên môn rèn chữ, dạy phát âm chuẩn và toán tư duy mầm non.', 'MARKETPLACE', 209, 1),
