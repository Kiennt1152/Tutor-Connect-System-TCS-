...
-- =====================================================================
-- Địa giới hành chính: 34 tỉnh/thành MỚI (sáp nhập 2025) + Quận/Huyện +
-- Phường/Xã (gắn theo bản đồ sáp nhập). Dữ liệu quận/huyện/phường/xã lấy
-- từ bộ dữ liệu hành chính chuẩn, quy về tỉnh mới.
-- =====================================================================
SET NAMES utf8mb4;
...
CREATE TABLE IF NOT EXISTS wards (
    ...
    CONSTRAINT fk_wards_district FOREIGN KEY (district_id) REFERENCES districts (district_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dọn dữ liệu tỉnh/địa điểm cũ để nạp lại (idempotent nhờ DELETE trước INSERT).
DELETE FROM wards;
DELETE FROM districts;
UPDATE tutoring_classes SET location_id = NULL WHERE location_id IS NOT NULL;
...
INSERT INTO districts (district_id, district_name, province_id) VALUES
    ...
    (30, 'Huyện Vị Xuyên', 7),
    (31, 'Huyện Bắc Mê', 7),
    (32, 'Huyện Hoàng Su Phì', 7),
    (33, 'Huyện Xín Mần', 7),
    (34, 'Huyện Bắc Quang', 7),
    (35, 'Huyện Quang Bình', 7),
    (40, 'Thành phố Cao Bằng', 16),
    (42, 'Huyện Bảo Lâm', 16),
    (43, 'Huyện Bảo Lạc', 16),
    (45, 'Huyện Hà Quảng', 16),
    (47, 'Huyện Trùng Khánh', 16),
    (48, 'Huyện Hạ Lang', 16),
    (49, 'Huyện Quảng Hòa', 16),
    (51, 'Huyện Hoà An', 16),
    (52, 'Huyện Nguyên Bình', 16),
    (53, 'Huyện Thạch An', 16),
    (58, 'Thành Phố Bắc Kạn', 9),
    (60, 'Huyện Pác Nặm', 9),
    (61, 'Huyện Ba Bể', 9),
    (62, 'Huyện Ngân Sơn', 9),
    (63, 'Huyện Bạch Thông', 9),
    (64, 'Huyện Chợ Đồn', 9),
    (65, 'Huyện Chợ Mới', 9),
    (66, 'Huyện Na Rì', 9),
    (70, 'Thành phố Tuyên Quang', 7),
    (71, 'Huyện Lâm Bình', 7),
    (72, 'Huyện Na Hang', 7),
    (73, 'Huyện Chiêm Hóa', 7),
    (74, 'Huyện Hàm Yên', 7),
    (75, 'Huyện Yên Sơn', 7),
    (76, 'Huyện Sơn Dương', 7),
    (80, 'Thành phố Lào Cai', 8),
    (82, 'Huyện Bát Xát', 8),
    (83, 'Huyện Mường Khương', 8),
    (84, 'Huyện Si Ma Cai', 8),
    (85, 'Huyện Bắc Hà', 8),
    (86, 'Huyện Bảo Thắng', 8),
    (87, 'Huyện Bảo Yên', 8),
    (88, 'Thị xã Sa Pa', 8),
    (89, 'Huyện Văn Bàn', 8),
    (94, 'Thành phố Điện Biên Phủ', 18),
    (95, 'Thị Xã Mường Lay', 18),
    (96, 'Huyện Mường Nhé', 18),
    (97, 'Huyện Mường Chà', 18),
    (98, 'Huyện Tủa Chùa', 18),
    (99, 'Huyện Tuần Giáo', 18),
    (100, 'Huyện Điện Biên', 18),
    (101, 'Huyện Điện Biên Đông', 18),
    (102, 'Huyện Mường Ảng', 18),
    (103, 'Huyện Nậm Pồ', 18),
    (105, 'Thành phố Lai Châu', 17),
    (106, 'Huyện Tam Đường', 17),
    (107, 'Huyện Mường Tè', 17),
    (108, 'Huyện Sìn Hồ', 17),
    (109, 'Huyện Phong Thổ', 17),
    (110, 'Huyện Than Uyên', 17),
    (111, 'Huyện Tân Uyên', 17),
    (112, 'Huyện Nậm Nhùn', 17),
    (116, 'Thành phố Sơn La', 19),
    (118, 'Huyện Quỳnh Nhai', 19),
    (119, 'Huyện Thuận Châu', 19),
    (120, 'Huyện Mường La', 19),
    (121, 'Huyện Bắc Yên', 19),
    (122, 'Huyện Phù Yên', 19),
    (123, 'Thị xã Mộc Châu', 19),
    (124, 'Huyện Yên Châu', 19),
    (125, 'Huyện Mai Sơn', 19),
    (126, 'Huyện Sông Mã', 19),
    (127, 'Huyện Sốp Cộp', 19),
    (128, 'Huyện Vân Hồ', 19),
    (132, 'Thành phố Yên Bái', 8),
    (133, 'Thị xã Nghĩa Lộ', 8),
    (135, 'Huyện Lục Yên', 8),
    (136, 'Huyện Văn Yên', 8),
    (137, 'Huyện Mù Căng Chải', 8),
    (138, 'Huyện Trấn Yên', 8),
    (139, 'Huyện Trạm Tấu', 8),
    (140, 'Huyện Văn Chấn', 8),
    (141, 'Huyện Yên Bình', 8),
    (148, 'Thành phố Hòa Bình', 10),
    (150, 'Huyện Đà Bắc', 10),
    (152, 'Huyện Lương Sơn', 10),
    (153, 'Huyện Kim Bôi', 10),
    (154, 'Huyện Cao Phong', 10),
    (155, 'Huyện Tân Lạc', 10),
    (156, 'Huyện Mai Châu', 10),
    (157, 'Huyện Lạc Sơn', 10),
    (158, 'Huyện Yên Thủy', 10),
    (159, 'Huyện Lạc Thủy', 10),
    (164, 'Thành phố Thái Nguyên', 9),
    (165, 'Thành phố Sông Công', 9),
    (167, 'Huyện Định Hóa', 9),
    (168, 'Huyện Phú Lương', 9),
    (169, 'Huyện Đồng Hỷ', 9),
    (170, 'Huyện Võ Nhai', 9),
    (171, 'Huyện Đại Từ', 9),
    (172, 'Thành phố Phổ Yên', 9),
    (173, 'Huyện Phú Bình', 9),
    (178, 'Thành phố Lạng Sơn', 15),
    (180, 'Huyện Tràng Định', 15),
    (181, 'Huyện Bình Gia', 15),
    (182, 'Huyện Văn Lãng', 15),
    (183, 'Huyện Cao Lộc', 15),
    (184, 'Huyện Văn Quan', 15),
    (185, 'Huyện Bắc Sơn', 15),
    (186, 'Huyện Hữu Lũng', 15),
    (187, 'Huyện Chi Lăng', 15),
    (188, 'Huyện Lộc Bình', 15),
    (189, 'Huyện Đình Lập', 15),
    (193, 'Thành phố Hạ Long', 14),
    (194, 'Thành phố Móng Cái', 14),
    (195, 'Thành phố Cẩm Phả', 14),
    (196, 'Thành phố Uông Bí', 14),
    (198, 'Huyện Bình Liêu', 14),
    (199, 'Huyện Tiên Yên', 14),
    (200, 'Huyện Đầm Hà', 14),
    (201, 'Huyện Hải Hà', 14),
    (202, 'Huyện Ba Chẽ', 14),
    (203, 'Huyện Vân Đồn', 14),
    (205, 'Thành phố Đông Triều', 14),
    (206, 'Thị xã Quảng Yên', 14),
    (207, 'Huyện Cô Tô', 14),
    (213, 'Thành phố Bắc Giang', 11),
    (215, 'Huyện Yên Thế', 11),
    (216, 'Huyện Tân Yên', 11),
    (217, 'Huyện Lạng Giang', 11),
    (218, 'Huyện Lục Nam', 11),
    (219, 'Huyện Lục Ngạn', 11),
    (220, 'Huyện Sơn Động', 11),
    (222, 'Thị Xã Việt Yên', 11),
    (223, 'Huyện Hiệp Hòa', 11),
    (224, 'Thị xã Chũ', 11),
    (227, 'Thành phố Việt Trì', 10),
    (228, 'Thị xã Phú Thọ', 10),
    (230, 'Huyện Đoan Hùng', 10),
    (231, 'Huyện Hạ Hoà', 10),
    (232, 'Huyện Thanh Ba', 10),
    (233, 'Huyện Phù Ninh', 10),
    (234, 'Huyện Yên Lập', 10),
    (235, 'Huyện Cẩm Khê', 10),
    (236, 'Huyện Tam Nông', 10),
    (237, 'Huyện Lâm Thao', 10),
    (238, 'Huyện Thanh Sơn', 10),
    (239, 'Huyện Thanh Thuỷ', 10),
    (240, 'Huyện Tân Sơn', 10),
    (243, 'Thành phố Vĩnh Yên', 10),
    (244, 'Thành phố Phúc Yên', 10),
    (246, 'Huyện Lập Thạch', 10),
    (247, 'Huyện Tam Dương', 10),
    (248, 'Huyện Tam Đảo', 10),
    (249, 'Huyện Bình Xuyên', 10),
    (251, 'Huyện Yên Lạc', 10),
    (252, 'Huyện Vĩnh Tường', 10),
    (253, 'Huyện Sông Lô', 10),
    (256, 'Thành phố Bắc Ninh', 11),
    (258, 'Huyện Yên Phong', 11),
    (259, 'Thị xã Quế Võ', 11),
    (260, 'Huyện Tiên Du', 11),
    (261, 'Thành phố Từ Sơn', 11),
    (262, 'Thị xã Thuận Thành', 11),
    (263, 'Huyện Gia Bình', 11),
    (264, 'Huyện Lương Tài', 11),
    (288, 'Thành phố Hải Dương', 2),
    (290, 'Thành phố Chí Linh', 2),
    (291, 'Huyện Nam Sách', 2),
    (292, 'Thị xã Kinh Môn', 2),
    (293, 'Huyện Kim Thành', 2),
    (294, 'Huyện Thanh Hà', 2),
    (295, 'Huyện Cẩm Giàng', 2),
    (296, 'Huyện Bình Giang', 2),
    (297, 'Huyện Gia Lộc', 2),
    (298, 'Huyện Tứ Kỳ', 2),
    (299, 'Huyện Ninh Giang', 2),
    (300, 'Huyện Thanh Miện', 2),
    (303, 'Quận Hồng Bàng', 2),
    (304, 'Quận Ngô Quyền', 2),
    (305, 'Quận Lê Chân', 2),
    (306, 'Quận Hải An', 2),
    (307, 'Quận Kiến An', 2),
    (308, 'Quận Đồ Sơn', 2),
    (309, 'Quận Dương Kinh', 2),
    (311, 'Thành phố Thuỷ Nguyên', 2),
    (312, 'Quận An Dương', 2),
    (313, 'Huyện An Lão', 2),
    (314, 'Huyện Kiến Thuỵ', 2),
    (315, 'Huyện Tiên Lãng', 2),
    (316, 'Huyện Vĩnh Bảo', 2),
    (317, 'Huyện Cát Hải', 2),
    (318, 'Huyện Bạch Long Vĩ', 2),
    (323, 'Thành phố Hưng Yên', 12),
    (325, 'Huyện Văn Lâm', 12),
    (326, 'Huyện Văn Giang', 12),
    (327, 'Huyện Yên Mỹ', 12),
    (328, 'Thị xã Mỹ Hào', 12),
    (329, 'Huyện Ân Thi', 12),
    (330, 'Huyện Khoái Châu', 12),
    (331, 'Huyện Kim Động', 12),
    (332, 'Huyện Tiên Lữ', 12),
    (333, 'Huyện Phù Cừ', 12),
    (336, 'Thành phố Thái Bình', 12),
    (338, 'Huyện Quỳnh Phụ', 12),
    (339, 'Huyện Hưng Hà', 12),
    (340, 'Huyện Đông Hưng', 12),
    (341, 'Huyện Thái Thụy', 12),
    (342, 'Huyện Tiền Hải', 12),
    (343, 'Huyện Kiến Xương', 12),
    (344, 'Huyện Vũ Thư', 12),
    (347, 'Thành phố Phủ Lý', 13),
    (349, 'Thị xã Duy Tiên', 13),
    (350, 'Thị xã Kim Bảng', 13),
    (351, 'Huyện Thanh Liêm', 13),
    (352, 'Huyện Bình Lục', 13),
    (353, 'Huyện Lý Nhân', 13),
    (356, 'Thành phố Nam Định', 13),
    (359, 'Huyện Vụ Bản', 13),
    (360, 'Huyện Ý Yên', 13),
    (361, 'Huyện Nghĩa Hưng', 13),
    (362, 'Huyện Nam Trực', 13),
    (363, 'Huyện Trực Ninh', 13),
    (364, 'Huyện Xuân Trường', 13),
    (365, 'Huyện Giao Thủy', 13),
    (366, 'Huyện Hải Hậu', 13),
    (370, 'Thành phố Tam Điệp', 13),
    (372, 'Huyện Nho Quan', 13),
    (373, 'Huyện Gia Viễn', 13),
    (374, 'Thành phố Hoa Lư', 13),
    (375, 'Huyện Yên Khánh', 13),
    (376, 'Huyện Kim Sơn', 13),
    (377, 'Huyện Yên Mô', 13),
    (380, 'Thành phố Thanh Hóa', 20),
    (381, 'Thị xã Bỉm Sơn', 20),
    (382, 'Thành phố Sầm Sơn', 20),
    (384, 'Huyện Mường Lát', 20),
    (385, 'Huyện Quan Hóa', 20),
    (386, 'Huyện Bá Thước', 20),
    (387, 'Huyện Quan Sơn', 20),
    (388, 'Huyện Lang Chánh', 20),
    (389, 'Huyện Ngọc Lặc', 20),
    (390, 'Huyện Cẩm Thủy', 20),
    (391, 'Huyện Thạch Thành', 20),
    (392, 'Huyện Hà Trung', 20),
    (393, 'Huyện Vĩnh Lộc', 20),
    (394, 'Huyện Yên Định', 20),
    (395, 'Huyện Thọ Xuân', 20),
    (396, 'Huyện Thường Xuân', 20),
    (397, 'Huyện Triệu Sơn', 20),
    (398, 'Huyện Thiệu Hóa', 20),
    (399, 'Huyện Hoằng Hóa', 20),
    (400, 'Huyện Hậu Lộc', 20),
    (401, 'Huyện Nga Sơn', 20),
    (402, 'Huyện Như Xuân', 20),
    (403, 'Huyện Như Thanh', 20),
    (404, 'Huyện Nông Cống', 20),
    (406, 'Huyện Quảng Xương', 20),
    (407, 'Thị xã Nghi Sơn', 20),
    (412, 'Thành phố Vinh', 21),
    (414, 'Thị xã Thái Hoà', 21),
    (415, 'Huyện Quế Phong', 21),
    (416, 'Huyện Quỳ Châu', 21),
    (417, 'Huyện Kỳ Sơn', 21),
    (418, 'Huyện Tương Dương', 21),
    (419, 'Huyện Nghĩa Đàn', 21),
    (420, 'Huyện Quỳ Hợp', 21),
    (421, 'Huyện Quỳnh Lưu', 21),
    (422, 'Huyện Con Cuông', 21),
    (423, 'Huyện Tân Kỳ', 21),
    (424, 'Huyện Anh Sơn', 21),
    (425, 'Huyện Diễn Châu', 21),
    (426, 'Huyện Yên Thành', 21),
    (427, 'Huyện Đô Lương', 21),
    (428, 'Huyện Thanh Chương', 21),
    (429, 'Huyện Nghi Lộc', 21),
    (430, 'Huyện Nam Đàn', 21),
    (431, 'Huyện Hưng Nguyên', 21),
    (432, 'Thị xã Hoàng Mai', 21),
    (436, 'Thành phố Hà Tĩnh', 22),
    (437, 'Thị xã Hồng Lĩnh', 22),
    (439, 'Huyện Hương Sơn', 22),
    (440, 'Huyện Đức Thọ', 22),
    (441, 'Huyện Vũ Quang', 22),
    (442, 'Huyện Nghi Xuân', 22),
    (443, 'Huyện Can Lộc', 22),
    (444, 'Huyện Hương Khê', 22),
    (445, 'Huyện Thạch Hà', 22),
    (446, 'Huyện Cẩm Xuyên', 22),
    (447, 'Huyện Kỳ Anh', 22),
    (449, 'Thị xã Kỳ Anh', 22),
    (450, 'Thành Phố Đồng Hới', 23),
    (452, 'Huyện Minh Hóa', 23),
    (453, 'Huyện Tuyên Hóa', 23),
    (454, 'Huyện Quảng Trạch', 23),
    (455, 'Huyện Bố Trạch', 23),
    (456, 'Huyện Quảng Ninh', 23),
    (457, 'Huyện Lệ Thủy', 23),
    (458, 'Thị xã Ba Đồn', 23),
    (461, 'Thành phố Đông Hà', 23),
    (462, 'Thị xã Quảng Trị', 23),
    (464, 'Huyện Vĩnh Linh', 23),
    (465, 'Huyện Hướng Hóa', 23),
    (466, 'Huyện Gio Linh', 23),
    (467, 'Huyện Đa Krông', 23),
    (468, 'Huyện Cam Lộ', 23),
    (469, 'Huyện Triệu Phong', 23),
    (470, 'Huyện Hải Lăng', 23),
    (471, 'Huyện Cồn Cỏ', 23),
    (474, 'Quận Thuận Hóa', 3),
    (475, 'Quận Phú Xuân', 3),
    (476, 'Thị xã Phong Điền', 3),
    (477, 'Huyện Quảng Điền', 3),
    (478, 'Huyện Phú Vang', 3),
    (479, 'Thị xã Hương Thủy', 3),
    (480, 'Thị xã Hương Trà', 3),
    (481, 'Huyện A Lưới', 3),
    (482, 'Huyện Phú Lộc', 3),
    (490, 'Quận Liên Chiểu', 4),
    (491, 'Quận Thanh Khê', 4),
    (492, 'Quận Hải Châu', 4),
    (493, 'Quận Sơn Trà', 4),
    (494, 'Quận Ngũ Hành Sơn', 4),
    (495, 'Quận Cẩm Lệ', 4),
    (497, 'Huyện Hòa Vang', 4),
    (498, 'Huyện Hoàng Sa', 4),
    (502, 'Thành phố Tam Kỳ', 4),
    (503, 'Thành phố Hội An', 4),
    (504, 'Huyện Tây Giang', 4),
    (505, 'Huyện Đông Giang', 4),
    (506, 'Huyện Đại Lộc', 4),
    (507, 'Thị xã Điện Bàn', 4),
    (508, 'Huyện Duy Xuyên', 4),
    (509, 'Huyện Quế Sơn', 4),
    (510, 'Huyện Nam Giang', 4),
    (511, 'Huyện Phước Sơn', 4),
    (512, 'Huyện Hiệp Đức', 4),
    (513, 'Huyện Thăng Bình', 4),
    (514, 'Huyện Tiên Phước', 4),
    (515, 'Huyện Bắc Trà My', 4),
    (516, 'Huyện Nam Trà My', 4),
    (517, 'Huyện Núi Thành', 4),
    (518, 'Huyện Phú Ninh', 4),
    (522, 'Thành phố Quảng Ngãi', 24),
    (524, 'Huyện Bình Sơn', 24),
    (525, 'Huyện Trà Bồng', 24),
    (527, 'Huyện Sơn Tịnh', 24),
    (528, 'Huyện Tư Nghĩa', 24),
    (529, 'Huyện Sơn Hà', 24),
    (530, 'Huyện Sơn Tây', 24),
    (531, 'Huyện Minh Long', 24),
    (532, 'Huyện Nghĩa Hành', 24),
    (533, 'Huyện Mộ Đức', 24),
    (534, 'Thị xã Đức Phổ', 24),
    (535, 'Huyện Ba Tơ', 24),
    (536, 'Huyện Lý Sơn', 24),
    (540, 'Thành phố Quy Nhơn', 25),
    (542, 'Huyện An Lão', 25),
    (543, 'Thị xã Hoài Nhơn', 25),
    (544, 'Huyện Hoài Ân', 25),
    (545, 'Huyện Phù Mỹ', 25),
    (546, 'Huyện Vĩnh Thạnh', 25),
    (547, 'Huyện Tây Sơn', 25),
    (548, 'Huyện Phù Cát', 25),
    (549, 'Thị xã An Nhơn', 25),
    (550, 'Huyện Tuy Phước', 25),
    (551, 'Huyện Vân Canh', 25),
    (555, 'Thành phố Tuy Hoà', 26),
    (557, 'Thị xã Sông Cầu', 26),
    (558, 'Huyện Đồng Xuân', 26),
    (559, 'Huyện Tuy An', 26),
    (560, 'Huyện Sơn Hòa', 26),
    (561, 'Huyện Sông Hinh', 26),
    (562, 'Huyện Tây Hoà', 26),
    (563, 'Huyện Phú Hoà', 26),
    (564, 'Thị xã Đông Hòa', 26),
    (568, 'Thành phố Nha Trang', 27),
    (569, 'Thành phố Cam Ranh', 27),
    (570, 'Huyện Cam Lâm', 27),
    (571, 'Huyện Vạn Ninh', 27),
    (572, 'Thị xã Ninh Hòa', 27),
    (573, 'Huyện Khánh Vĩnh', 27),
    (574, 'Huyện Diên Khánh', 27),
    (575, 'Huyện Khánh Sơn', 27),
    (576, 'Huyện Trường Sa', 27),
    (582, 'Thành phố Phan Rang-Tháp Chàm', 27),
    (584, 'Huyện Bác Ái', 27),
    (585, 'Huyện Ninh Sơn', 27),
    (586, 'Huyện Ninh Hải', 27),
    (587, 'Huyện Ninh Phước', 27),
    (588, 'Huyện Thuận Bắc', 27),
    (589, 'Huyện Thuận Nam', 27),
    (593, 'Thành phố Phan Thiết', 28),
    (594, 'Thị xã La Gi', 28),
    (595, 'Huyện Tuy Phong', 28),
    (596, 'Huyện Bắc Bình', 28),
    (597, 'Huyện Hàm Thuận Bắc', 28),
    (598, 'Huyện Hàm Thuận Nam', 28),
    (599, 'Huyện Tánh Linh', 28),
    (600, 'Huyện Đức Linh', 28),
    (601, 'Huyện Hàm Tân', 28),
    (602, 'Huyện Phú Quí', 28),
    (608, 'Thành phố Kon Tum', 24),
    (610, 'Huyện Đắk Glei', 24),
    (611, 'Huyện Ngọc Hồi', 24),
    (612, 'Huyện Đắk Tô', 24),
    (613, 'Huyện Kon Plông', 24),
    (614, 'Huyện Kon Rẫy', 24),
    (615, 'Huyện Đắk Hà', 24),
    (616, 'Huyện Sa Thầy', 24),
    (617, 'Huyện Tu Mơ Rông', 24),
    (618, 'Huyện Ia H'' Drai', 24),
    (622, 'Thành phố Pleiku', 25),
    (623, 'Thị xã An Khê', 25),
    (624, 'Thị xã Ayun Pa', 25),
    (625, 'Huyện KBang', 25),
    (626, 'Huyện Đăk Đoa', 25),
    (627, 'Huyện Chư Păh', 25),
    (628, 'Huyện Ia Grai', 25),
    (629, 'Huyện Mang Yang', 25),
    (630, 'Huyện Kông Chro', 25),
    (631, 'Huyện Đức Cơ', 25),
    (632, 'Huyện Chư Prông', 25),
    (633, 'Huyện Chư Sê', 25),
    (634, 'Huyện Đăk Pơ', 25),
    (635, 'Huyện Ia Pa', 25),
    (637, 'Huyện Krông Pa', 25),
    (638, 'Huyện Phú Thiện', 25),
    (639, 'Huyện Chư Pưh', 25),
    (643, 'Thành phố Buôn Ma Thuột', 26),
    (644, 'Thị Xã Buôn Hồ', 26),
    (645, 'Huyện Ea H''leo', 26),
    (646, 'Huyện Ea Súp', 26),
    (647, 'Huyện Buôn Đôn', 26),
    (648, 'Huyện Cư M''gar', 26),
    (649, 'Huyện Krông Búk', 26),
    (650, 'Huyện Krông Năng', 26),
    (651, 'Huyện Ea Kar', 26),
    (652, 'Huyện M''Đrắk', 26),
    (653, 'Huyện Krông Bông', 26),
    (654, 'Huyện Krông Pắc', 26),
    (655, 'Huyện Krông A Na', 26),
    (656, 'Huyện Lắk', 26),
    (657, 'Huyện Cư Kuin', 26),
    (660, 'Thành phố Gia Nghĩa', 28),
    (661, 'Huyện Đăk Glong', 28),
    (662, 'Huyện Cư Jút', 28),
    (663, 'Huyện Đắk Mil', 28),
    (664, 'Huyện Krông Nô', 28),
    (665, 'Huyện Đắk Song', 28),
    (666, 'Huyện Đắk R''Lấp', 28),
    (667, 'Huyện Tuy Đức', 28),
    (672, 'Thành phố Đà Lạt', 28),
    (673, 'Thành phố Bảo Lộc', 28),
    (674, 'Huyện Đam Rông', 28),
    (675, 'Huyện Lạc Dương', 28),
    (676, 'Huyện Lâm Hà', 28),
    (677, 'Huyện Đơn Dương', 28),
    (678, 'Huyện Đức Trọng', 28),
    (679, 'Huyện Di Linh', 28),
    (680, 'Huyện Bảo Lâm', 28),
    (682, 'Huyện Đạ Huoai', 28),
    (688, 'Thị xã Phước Long', 29),
    (689, 'Thành phố Đồng Xoài', 29),
    (690, 'Thị xã Bình Long', 29),
    (691, 'Huyện Bù Gia Mập', 29),
    (692, 'Huyện Lộc Ninh', 29),
    (693, 'Huyện Bù Đốp', 29),
    (694, 'Huyện Hớn Quản', 29);
INSERT INTO districts (district_id, district_name, province_id) VALUES
    (695, 'Huyện Đồng Phú', 29),
    (696, 'Huyện Bù Đăng', 29),
    (697, 'Thị xã Chơn Thành', 29),
    (698, 'Huyện Phú Riềng', 29),
    (703, 'Thành phố Tây Ninh', 30),
    (705, 'Huyện Tân Biên', 30),
    (706, 'Huyện Tân Châu', 30),
    (707, 'Huyện Dương Minh Châu', 30),
    (708, 'Huyện Châu Thành', 30),
    (709, 'Thị xã Hòa Thành', 30),
    (710, 'Huyện Gò Dầu', 30),
    (711, 'Huyện Bến Cầu', 30),
    (712, 'Thị xã Trảng Bàng', 30),
    (718, 'Thành phố Thủ Dầu Một', 5),
    (719, 'Huyện Bàu Bàng', 5),
    (720, 'Huyện Dầu Tiếng', 5),
    (721, 'Thành phố Bến Cát', 5),
    (722, 'Huyện Phú Giáo', 5),
    (723, 'Thành phố Tân Uyên', 5),
    (724, 'Thành phố Dĩ An', 5),
    (725, 'Thành phố Thuận An', 5),
    (726, 'Huyện Bắc Tân Uyên', 5),
    (731, 'Thành phố Biên Hòa', 29),
    (732, 'Thành phố Long Khánh', 29),
    (734, 'Huyện Tân Phú', 29),
    (735, 'Huyện Vĩnh Cửu', 29),
    (736, 'Huyện Định Quán', 29),
    (737, 'Huyện Trảng Bom', 29),
    (738, 'Huyện Thống Nhất', 29),
    (739, 'Huyện Cẩm Mỹ', 29),
    (740, 'Huyện Long Thành', 29),
    (741, 'Huyện Xuân Lộc', 29),
    (742, 'Huyện Nhơn Trạch', 29),
    (747, 'Thành phố Vũng Tàu', 5),
    (748, 'Thành phố Bà Rịa', 5),
    (750, 'Huyện Châu Đức', 5),
    (751, 'Huyện Xuyên Mộc', 5),
    (753, 'Huyện Long Đất', 5),
    (754, 'Thành phố Phú Mỹ', 5),
    (755, 'Huyện Côn Đảo', 5),
    (760, 'Quận 1', 5),
    (761, 'Quận 12', 5),
    (764, 'Quận Gò Vấp', 5),
    (765, 'Quận Bình Thạnh', 5),
    (766, 'Quận Tân Bình', 5),
    (767, 'Quận Tân Phú', 5),
    (768, 'Quận Phú Nhuận', 5),
    (769, 'Thành phố Thủ Đức', 5),
    (770, 'Quận 3', 5),
    (771, 'Quận 10', 5),
    (772, 'Quận 11', 5),
    (773, 'Quận 4', 5),
    ...
    (783, 'Huyện Củ Chi', 5),
    (784, 'Huyện Hóc Môn', 5),
    (785, 'Huyện Bình Chánh', 5),
    (786, 'Huyện Nhà Bè', 5),
    (787, 'Huyện Cần Giờ', 5),
    (794, 'Thành phố Tân An', 30),
    (795, 'Thị xã Kiến Tường', 30),
    (796, 'Huyện Tân Hưng', 30),
    (797, 'Huyện Vĩnh Hưng', 30),
    (798, 'Huyện Mộc Hóa', 30),
    (799, 'Huyện Tân Thạnh', 30),
    (800, 'Huyện Thạnh Hóa', 30),
    (801, 'Huyện Đức Huệ', 30),
    (802, 'Huyện Đức Hòa', 30),
    (803, 'Huyện Bến Lức', 30),
    (804, 'Huyện Thủ Thừa', 30),
    (805, 'Huyện Tân Trụ', 30),
    (806, 'Huyện Cần Đước', 30),
    (807, 'Huyện Cần Giuộc', 30),
    (808, 'Huyện Châu Thành', 30),
    (815, 'Thành phố Mỹ Tho', 32),
    (816, 'Thành phố Gò Công', 32),
    (817, 'Thị xã Cai Lậy', 32),
    (818, 'Huyện Tân Phước', 32),
    (819, 'Huyện Cái Bè', 32),
    (820, 'Huyện Cai Lậy', 32),
    (821, 'Huyện Châu Thành', 32),
    (822, 'Huyện Chợ Gạo', 32),
    (823, 'Huyện Gò Công Tây', 32),
    (824, 'Huyện Gò Công Đông', 32),
    (825, 'Huyện Tân Phú Đông', 32),
    (829, 'Thành phố Bến Tre', 31),
    (831, 'Huyện Châu Thành', 31),
    (832, 'Huyện Chợ Lách', 31),
    (833, 'Huyện Mỏ Cày Nam', 31),
    (834, 'Huyện Giồng Trôm', 31),
    (835, 'Huyện Bình Đại', 31),
    (836, 'Huyện Ba Tri', 31),
    (837, 'Huyện Thạnh Phú', 31),
    (838, 'Huyện Mỏ Cày Bắc', 31),
    (842, 'Thành phố Trà Vinh', 31),
    (844, 'Huyện Càng Long', 31),
    (845, 'Huyện Cầu Kè', 31),
    (846, 'Huyện Tiểu Cần', 31),
    (847, 'Huyện Châu Thành', 31),
    (848, 'Huyện Cầu Ngang', 31),
    (849, 'Huyện Trà Cú', 31),
    (850, 'Huyện Duyên Hải', 31),
    (851, 'Thị xã Duyên Hải', 31),
    (855, 'Thành phố Vĩnh Long', 31),
    (857, 'Huyện Long Hồ', 31),
    (858, 'Huyện Mang Thít', 31),
    (859, 'Huyện  Vũng Liêm', 31),
    (860, 'Huyện Tam Bình', 31),
    (861, 'Thị xã Bình Minh', 31),
    (862, 'Huyện Trà Ôn', 31),
    (863, 'Huyện Bình Tân', 31),
    (866, 'Thành phố Cao Lãnh', 32),
    (867, 'Thành phố Sa Đéc', 32),
    (868, 'Thành phố Hồng Ngự', 32),
    (869, 'Huyện Tân Hồng', 32),
    (870, 'Huyện Hồng Ngự', 32),
    (871, 'Huyện Tam Nông', 32),
    (872, 'Huyện Tháp Mười', 32),
    (873, 'Huyện Cao Lãnh', 32),
    (874, 'Huyện Thanh Bình', 32),
    (875, 'Huyện Lấp Vò', 32),
    (876, 'Huyện Lai Vung', 32),
    (877, 'Huyện Châu Thành', 32),
    (883, 'Thành phố Long Xuyên', 33),
    (884, 'Thành phố Châu Đốc', 33),
    (886, 'Huyện An Phú', 33),
    (887, 'Thị xã Tân Châu', 33),
    (888, 'Huyện Phú Tân', 33),
    (889, 'Huyện Châu Phú', 33),
    (890, 'Thị xã Tịnh Biên', 33),
    (891, 'Huyện Tri Tôn', 33),
    (892, 'Huyện Châu Thành', 33),
    (893, 'Huyện Chợ Mới', 33),
    (894, 'Huyện Thoại Sơn', 33),
    (899, 'Thành phố Rạch Giá', 33),
    (900, 'Thành phố Hà Tiên', 33),
    (902, 'Huyện Kiên Lương', 33),
    (903, 'Huyện Hòn Đất', 33),
    (904, 'Huyện Tân Hiệp', 33),
    (905, 'Huyện Châu Thành', 33),
    (906, 'Huyện Giồng Riềng', 33),
    (907, 'Huyện Gò Quao', 33),
    (908, 'Huyện An Biên', 33),
    (909, 'Huyện An Minh', 33),
    (910, 'Huyện Vĩnh Thuận', 33),
    (911, 'Thành phố Phú Quốc', 33),
    (912, 'Huyện Kiên Hải', 33),
    (913, 'Huyện U Minh Thượng', 33),
    (914, 'Huyện Giang Thành', 33),
    (916, 'Quận Ninh Kiều', 6),
    (917, 'Quận Ô Môn', 6),
    (918, 'Quận Bình Thuỷ', 6),
    (919, 'Quận Cái Răng', 6),
    (923, 'Quận Thốt Nốt', 6),
    (924, 'Huyện Vĩnh Thạnh', 6),
    (925, 'Huyện Cờ Đỏ', 6),
    (926, 'Huyện Phong Điền', 6),
    (927, 'Huyện Thới Lai', 6),
    (930, 'Thành phố Vị Thanh', 6),
    (931, 'Thành phố Ngã Bảy', 6),
    (932, 'Huyện Châu Thành A', 6),
    (933, 'Huyện Châu Thành', 6),
    (934, 'Huyện Phụng Hiệp', 6),
    (935, 'Huyện Vị Thuỷ', 6),
    (936, 'Huyện Long Mỹ', 6),
    (937, 'Thị xã Long Mỹ', 6),
    (941, 'Thành phố Sóc Trăng', 6),
    (942, 'Huyện Châu Thành', 6),
    (943, 'Huyện Kế Sách', 6),
    (944, 'Huyện Mỹ Tú', 6),
    (945, 'Huyện Cù Lao Dung', 6),
    (946, 'Huyện Long Phú', 6),
    (947, 'Huyện Mỹ Xuyên', 6),
    (948, 'Thị xã Ngã Năm', 6),
    (949, 'Huyện Thạnh Trị', 6),
    (950, 'Thị xã Vĩnh Châu', 6),
    (951, 'Huyện Trần Đề', 6),
    (954, 'Thành phố Bạc Liêu', 34),
    (956, 'Huyện Hồng Dân', 34),
    (957, 'Huyện Phước Long', 34),
    (958, 'Huyện Vĩnh Lợi', 34),
    (959, 'Thị xã Giá Rai', 34),
    (960, 'Huyện Đông Hải', 34),
    (961, 'Huyện Hoà Bình', 34),
    (964, 'Thành phố Cà Mau', 34),
    (966, 'Huyện U Minh', 34),
    (967, 'Huyện Thới Bình', 34),
    (968, 'Huyện Trần Văn Thời', 34),
    (969, 'Huyện Cái Nước', 34),
    (970, 'Huyện Đầm Dơi', 34),
    (971, 'Huyện Năm Căn', 34),
    (972, 'Huyện Phú Tân', 34),
    (973, 'Huyện Ngọc Hiển', 34);
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (181, 'Phường Văn Miếu - Quốc Tử Giám', 6),
    ...
    (226, 'Phường Phương Liên - Trung Tự', 6),
    (229, 'Phường Kim Liên', 6),
    (232, 'Phường Phương Mai', 6),
    (235, 'Phường Thịnh Quang', 6),
    ...
    (9742, 'Xã Tích Lộc', 272),
    (9745, 'Xã Long Thượng', 272),
    (9751, 'Xã Hát Môn', 272),
    ...
    (9928, 'Xã Liệp Nghĩa', 275),
    (9931, 'Xã Cộng Hòa', 275),
    (9934, 'Xã Hưng Đạo', 275),
    (9940, 'Xã Phú Mãn', 275),
    (9943, 'Xã Cấn Hữu', 275),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (3979, 'Phường Mộc Sơn', 123),
    (3980, 'Phường Mộc Lỵ', 123),
    (3982, 'Phường Thảo Nguyên', 123),
    (3983, 'Phường Bình Minh', 123),
    (3984, 'Phường Cờ Đỏ', 123),
    (3985, 'Xã Chiềng Sơn', 123),
    (3997, 'Xã Tân Yên', 123),
    (4000, 'Xã Đoàn Kết', 123),
    (4012, 'Xã Chiềng Hắc', 123),
    (4015, 'Xã Chiềng Chung', 123),
    (4024, 'Xã Chiềng Khừa', 123),
    (4027, 'Phường Mường Sang', 123),
    (4030, 'Phường Đông Sang', 123),
    (4033, 'Phường Vân Sơn', 123),
    (4045, 'Xã Lóng Sập', 123),
    (4063, 'Xã Chiềng Đông', 124),
    (4066, 'Xã Sặp Vạt', 124),
    (4069, 'Xã Chiềng Sàng', 124),
    (4072, 'Xã Chiềng Pằn', 124),
    (4075, 'Thị trấn Yên Châu', 124),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (7222, 'Phường Song Mai', 213),
    (7225, 'Phường Xương Giang', 213),
    (7228, 'Phường Đa Mai', 213),
    (7231, 'Phường Dĩnh Kế', 213),
    (7441, 'Phường Dĩnh Trì', 213),
    (7681, 'Phường Nham Biền', 213),
    (7682, 'Phường Tân An', 213),
    (7687, 'Phường Tân Mỹ', 213),
    (7690, 'Phường Hương Gián', 213),
    (7696, 'Phường Đồng Sơn', 213),
    (7699, 'Phường Tân Tiến', 213),
    (7702, 'Xã Quỳnh Sơn', 213),
    (7705, 'Phường Song Khê', 213),
    (7708, 'Phường Nội Hoàng', 213),
    (7711, 'Phường Tiền Phong', 213),
    (7714, 'Xã Xuân Phú', 213),
    (7717, 'Phường Tân Liễu', 213),
    (7720, 'Xã Trí Yên', 213),
    (7723, 'Xã Lãng Sơn', 213),
    (7726, 'Xã Yên Lư', 213),
    (7729, 'Xã Tiến Dũng', 213),
    (7735, 'Xã Đức Giang', 213),
    (7738, 'Phường Cảnh Thụy', 213),
    (7741, 'Xã Tư Mại', 213),
    (7747, 'Xã Đồng Việt', 213),
    (7750, 'Xã Đồng Phúc', 213),
    ...
    (7573, 'Thị trấn Biển Động', 219),
    (7582, 'Thị trấn Phì Điền', 219),
    ...
    (7525, 'Phường Chũ', 224),
    (7549, 'Phường Thanh Hải', 224),
    (7552, 'Xã Kiên Lao', 224),
    (7558, 'Xã Kiên Thành', 224),
    (7561, 'Phường Hồng Giang', 224),
    (7576, 'Xã Quý Sơn', 224),
    (7579, 'Phường Trù Hựu', 224),
    (7600, 'Xã Mỹ An', 224),
    (7603, 'Xã Nam Dương', 224),
    (7612, 'Phường Phượng Sơn', 224),
    ...
    (8023, 'Xã Tây Cốc', 230),
    (8035, 'Xã Hùng Long', 230),
    (8038, 'Xã Yên Kiện', 230),
    (8044, 'Xã Chân Mộng', 230),
    (8050, 'Xã Ca Đình', 230),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (10621, 'Xã Quốc Tuấn', 291),
    (10630, 'Xã An Bình', 291),
    (10633, 'Xã Trần Phú', 291),
    (10636, 'Xã An Sơn', 291),
    ...
    (10756, 'Xã Lai Khê', 293),
    (10762, 'Xã Vũ Dũng', 293),
    ...
    (11035, 'Xã Gia Phúc', 297),
    (11038, 'Xã Gia Tiến', 297),
    (11041, 'Xã Lê Lợi', 297),
    ...
    (11065, 'Xã Nhật Quang', 297),
    (11071, 'Xã Quang Đức', 297),
    ...
    (11587, 'Phường Đại Bản', 303),
    (11599, 'Phường An Hưng', 303),
    (11602, 'Phường An Hồng', 303),
    (11329, 'Phường Máy Chai', 304),
    (11335, 'Phường Vạn Mỹ', 304),
    (11338, 'Phường Cầu Tre', 304),
    (11341, 'Phường Gia Viên', 304),
    (11344, 'Phường Cầu Đất', 304),
    (11350, 'Phường Đông Khê', 304),
    (11359, 'Phường Đằng Giang', 304),
    (11365, 'Phường Lạch Tray', 304),
    (11371, 'Phường An Biên', 305),
    (11383, 'Phường Trần Nguyên Hãn', 305),
    (11395, 'Phường Hàng Kênh', 305),
    (11401, 'Phường An Dương', 305),
    ...
    (11473, 'Phường Minh Đức', 311),
    (11485, 'Xã Liên Xuân', 311),
    (11488, 'Phường Lưu Kiếm', 311),
    (11500, 'Xã Bạch Đằng', 311),
    (11503, 'Xã Ninh Sơn', 311),
    (11506, 'Phường Quảng Thanh', 311),
    (11512, 'Phường Trần Hưng Đạo', 311),
    (11518, 'Xã Quang Trung', 311),
    (11521, 'Phường Lê Hồng Phong', 311),
    (11527, 'Phường Hoà Bình', 311),
    (11530, 'Phường Thủy Hà', 311),
    (11533, 'Phường An Lư', 311),
    (11539, 'Phường Phạm Ngũ Lão', 311),
    (11542, 'Phường Nam Triệu Giang', 311),
    (11545, 'Phường Tam Hưng', 311),
    (11551, 'Phường Lập Lễ', 311),
    (11557, 'Phường Thiên Hương', 311),
    (11560, 'Phường Thuỷ Đường', 311),
    (11569, 'Phường Hoàng Lâm', 311),
    (11572, 'Phường Hoa Động', 311),
    (11578, 'Phường Dương Quan', 311),
    (11581, 'Phường Lê Lợi', 312),
    (11584, 'Phường Lê Thiện', 312),
    (11590, 'Phường An Hoà', 312),
    (11593, 'Phường Hồng Phong', 312),
    (11596, 'Phường Tân Tiến', 312),
    (11608, 'Phường Nam Sơn', 312),
    (11614, 'Phường An Hải', 312),
    (11617, 'Phường Đồng Thái', 312),
    (11623, 'Phường An Đồng', 312),
    (11626, 'Phường Hồng Thái', 312),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (11848, 'Xã Vĩnh Hoà', 316),
    (11851, 'Xã Hùng Tiến', 316),
    (11857, 'Xã Tân Hưng', 316),
    (11860, 'Xã Tân Liên', 316),
    (11866, 'Xã Vĩnh Hưng', 316),
    (11875, 'Xã Vĩnh Hải', 316),
    ...
    (12091, 'Xã Việt Yên', 327),
    (12100, 'Xã Tân Minh', 327),
    ...
    (13384, 'Phường Quế', 350),
    (13387, 'Xã Nguyễn Úy', 350),
    (13390, 'Phường Đại Cương', 350),
    (13393, 'Phường Lê Hồ', 350),
    (13396, 'Phường Tượng Lĩnh', 350),
    (13402, 'Phường Tân Tựu', 350),
    (13405, 'Phường Đồng Hóa', 350),
    (13408, 'Xã Hoàng Tây', 350);
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    (13411, 'Phường Tân Sơn', 350),
    (13414, 'Xã Thụy Lôi', 350),
    (13417, 'Xã Văn Xá', 350),
    (13420, 'Xã Khả Phong', 350),
    (13423, 'Phường Ngọc Sơn', 350),
    (13429, 'Phường Ba Sao', 350),
    (13432, 'Xã Liên Sơn', 350),
    (13435, 'Phường Thi Sơn', 350),
    ...
    (14428, 'Thị trấn Nho Quan', 372),
    (14431, 'Xã Văn Phương', 372),
    (14434, 'Xã Thanh Sơn', 372),
    (14437, 'Xã Phúc Sơn', 372),
    ...
    (14464, 'Thị trấn Thịnh Vượng', 373),
    ...
    (14506, 'Xã Tiến Thắng', 373),
    (14509, 'Xã Gia Trung', 373),
    (14512, 'Xã Gia Minh', 373),
    (14515, 'Xã Gia Lạc', 373),
    (14521, 'Xã Gia Sinh', 373),
    (14524, 'Xã Gia Phong', 373),
    (14320, 'Phường Đông Thành', 374),
    (14323, 'Phường Tân Thành', 374),
    (14329, 'Phường Vân Giang', 374),
    (14332, 'Phường Bích Đào', 374),
    (14338, 'Phường Nam Bình', 374),
    (14341, 'Phường Nam Thành', 374),
    (14344, 'Phường Ninh Khánh', 374),
    (14347, 'Xã Ninh Nhất', 374),
    (14350, 'Xã Ninh Tiến', 374),
    (14353, 'Phường Ninh Phúc', 374),
    (14356, 'Phường Ninh Sơn', 374),
    (14359, 'Phường Ninh Phong', 374),
    (14527, 'Phường Ninh Mỹ', 374),
    (14530, 'Phường Ninh Giang', 374),
    (14533, 'Xã Trường Yên', 374),
    (14536, 'Xã Ninh Khang', 374),
    (14542, 'Xã Ninh Hòa', 374),
    (14551, 'Xã Ninh Hải', 374),
    (14554, 'Xã Ninh Vân', 374),
    (14557, 'Xã Ninh An', 374),
    (14560, 'Thị trấn Yên Ninh', 375),
    (14563, 'Xã Khánh Thiện', 375),
    ...
    (15925, 'Phường Hoằng Quang', 380),
    (15970, 'Phường Hoằng Đại', 380),
    (16378, 'Phường Rừng Thông', 380),
    (16381, 'Xã Đông Hoàng', 380),
    (16384, 'Xã Đông Ninh', 380),
    (16390, 'Xã Đông Hòa', 380),
    (16393, 'Xã Đông Yên', 380),
    (16396, 'Phường Đông Lĩnh', 380),
    (16399, 'Xã Đông Minh', 380),
    (16402, 'Xã Đông Thanh', 380),
    (16405, 'Xã Đông Tiến', 380),
    (16408, 'Xã Đông Khê', 380),
    (16414, 'Phường Đông Thịnh', 380),
    (16417, 'Xã Đông Văn', 380),
    (16420, 'Xã Đông Phú', 380),
    (16423, 'Xã Đông Nam', 380),
    (16426, 'Xã Đông Quang', 380),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (16702, 'Phường Nghi Phú', 412),
    (16705, 'Phường Hưng Đông', 412),
    (16708, 'Phường Hưng Lộc', 412),
    (16711, 'Xã Hưng Hòa', 412),
    (16714, 'Phường Vinh Tân', 412),
    (16717, 'Phường Nghi Thuỷ', 412),
    (16720, 'Phường Nghi Tân', 412),
    (16723, 'Phường Thu Thuỷ', 412),
    (16726, 'Phường Nghi Hòa', 412),
    (16729, 'Phường Nghi Hải', 412),
    (16732, 'Phường Nghi Hương', 412),
    (16735, 'Phường Nghi Thu', 412),
    (17902, 'Xã Nghi Phong', 412),
    (17905, 'Xã Nghi Xuân', 412),
    (17908, 'Xã Nghi Liên', 412),
    (17914, 'Xã Nghi Ân', 412),
    (17917, 'Xã Phúc Thọ', 412),
    (17920, 'Xã Nghi Kim', 412),
    (17923, 'Phường Nghi Đức', 412),
    (17926, 'Xã Nghi Thái', 412),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (17176, 'Xã Minh Lương', 421),
    (17179, 'Thị trấn Cầu Giát', 421),
    (17182, 'Xã Quỳnh Yên', 421),
    (17185, 'Xã Bình Sơn', 421),
    (17191, 'Xã Quỳnh Diễn', 421),
    (17197, 'Xã Quỳnh Giang', 421),
    (17206, 'Xã An Hòa', 421),
    (17209, 'Xã Phú Nghĩa', 421),
    (17212, 'Xã Văn Hải', 421),
    (17218, 'Xã Thuận Long', 421),
    ...
    (17713, 'Thị trấn Dùng', 428),
    (17716, 'Xã Cát Văn', 428),
    (17719, 'Xã Minh Sơn', 428),
    ...
    (17776, 'Xã Thanh Quả', 428),
    (17779, 'Xã Xuân Dương', 428),
    (17785, 'Xã Minh Tiến', 428),
    (17791, 'Xã Kim Bảng', 428),
    (17797, 'Xã Thanh Thủy', 428),
    (17806, 'Xã Thanh Hà', 428),
    (17812, 'Xã Thanh Tùng', 428),
    (17815, 'Xã Thanh Lâm', 428),
    (17818, 'Xã Mai Giang', 428),
    ...
    (17896, 'Xã Thịnh Trường', 429),
    (17899, 'Xã Diên Hoa', 429),
    (17911, 'Xã Nghi Vạn', 429),
    (17932, 'Xã Nam Hưng', 430),
    (17935, 'Xã Nghĩa Thái', 430),
    ...
    (18022, 'Xã Thịnh Mỹ', 431),
    (18025, 'Xã Hưng Lĩnh', 431),
    (18028, 'Xã Thông Tân', 431),
    (18037, 'Xã Hưng Nghĩa', 431),
    (18040, 'Xã Phúc Lợi', 431),
    ...
    (18077, 'Phường Bắc Hà', 436),
    (18079, 'Phường Tân Giang', 436),
    (18082, 'Phường Đại Nài', 436),
    (18085, 'Phường Hà Huy Tập', 436),
    (18088, 'Phường Thạch Trung', 436),
    (18091, 'Phường Thạch Quý', 436),
    (18094, 'Phường Trần Phú', 436),
    (18097, 'Phường Văn Yên', 436),
    (18100, 'Phường Thạch Hạ', 436),
    (18103, 'Phường Đồng Môn', 436),
    (18109, 'Phường Thạch Hưng', 436),
    (18112, 'Xã Thạch Bình', 436),
    (18571, 'Xã Thạch Hải', 436),
    (18595, 'Xã Đỉnh Bàn', 436),
    (18598, 'Xã Hộ Độ', 436),
    (18604, 'Xã Thạch Khê', 436),
    (18619, 'Xã Thạch Trị', 436),
    (18622, 'Xã Thạch Lạc', 436),
    (18628, 'Xã Tượng Sơn', 436),
    (18631, 'Xã Thạch Văn', 436),
    (18637, 'Xã Thạch Thắng', 436),
    (18643, 'Xã Thạch Đài', 436),
    (18649, 'Xã Thạch Hội', 436),
    (18652, 'Xã Tân Lâm Hương', 436),
    (18685, 'Xã Cẩm Bình', 436),
    (18691, 'Xã Cẩm Vịnh', 436),
    ...
    (18202, 'Xã Mỹ Long', 439),
    (18211, 'Xã Kim Hoa', 439),
    (18217, 'Xã Sơn Phú', 439),
    (18223, 'Xã Hàm Trường', 439),
    ...
    (18409, 'Xã Tân Lộc', 445),
    (18412, 'Xã Hồng Lộc', 445),
    (18421, 'Xã Thịnh Lộc', 445),
    (18430, 'Xã Bình An', 445),
    (18457, 'Xã Ích Hậu', 445),
    (18493, 'Xã Phù Lưu', 445),
    (18562, 'Thị trấn Thạch Hà', 445),
    (18565, 'Xã Ngọc Sơn', 445),
    (18568, 'Thị trấn Lộc Hà', 445),
    (18577, 'Xã Thạch Mỹ', 445),
    (18580, 'Xã Thạch Kim', 445),
    (18583, 'Xã Thạch Châu', 445),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (19909, 'Phường Dương Nỗ', 474),
    (19930, 'Phường Phú Thượng', 474),
    (19963, 'Phường Thủy Vân', 474),
    (19981, 'Phường Thủy Bằng', 474),
    (20002, 'Phường Hương Phong', 474),
    (19750, 'Phường Tây Lộc', 475),
    (19753, 'Phường Thuận Lộc', 475),
    (19756, 'Phường Gia Hội', 475),
    (19759, 'Phường Phú Hậu', 475),
    (19762, 'Phường Thuận Hòa', 475),
    (19768, 'Phường Đông Ba', 475),
    (19774, 'Phường Kim Long', 475),
    (19803, 'Phường An Hòa', 475),
    (19804, 'Phường Hương Sơ', 475),
    (19810, 'Phường Hương Long', 475),
    (20014, 'Phường Hương Vinh', 475),
    (20023, 'Phường Hương An', 475),
    (20029, 'Phường Long Hồ', 475),
    (19819, 'Phường Phong Thu', 476),
    (19825, 'Xã Phong Thạnh', 476),
    (19828, 'Phường Phong Phú', 476),
    (19831, 'Xã Phong Bình', 476),
    (19837, 'Xã Phong Chương', 476),
    (19843, 'Phường Phong Hải', 476),
    (19846, 'Phường Phong Hòa', 476),
    (19852, 'Phường Phong Hiền', 476),
    (19855, 'Xã Phong Mỹ', 476),
    (19858, 'Phường Phong An', 476),
    ...
    (20161, 'Thị trấn Khe Tre', 482),
    (20164, 'Xã Hương Phú', 482),
    (20167, 'Xã Hương Sơn', 482),
    (20170, 'Xã Hương Lộc', 482),
    (20173, 'Xã Thượng Quảng', 482),
    (20179, 'Xã Hương Xuân', 482),
    (20182, 'Xã Hương Hữu', 482),
    (20185, 'Xã Thượng Lộ', 482),
    (20188, 'Xã Thượng Long', 482),
    (20191, 'Xã Thượng Nhật', 482),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (21580, 'Phường Trần Phú', 540),
    (21583, 'Phường Thị Nại', 540),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (25096, 'Thị trấn Đạ M''ri', 682),
    (25099, 'Thị trấn Ma Đa Guôi', 682),
    (25105, 'Xã Hà Lâm', 682),
    (25111, 'Xã Đạ Oai', 682),
    (25114, 'Xã Bà Gia', 682),
    (25117, 'Xã Ma Đa Guôi', 682),
    ...
    (25153, 'Xã Đạ Kho', 682),
    (25156, 'Xã Đạ Pal', 682),
    (25159, 'Thị trấn Cát Tiên', 682),
    (25162, 'Xã Tiên Hoàng', 682),
    (25165, 'Xã Phước Cát 2', 682),
    (25168, 'Xã Gia Viễn', 682),
    (25171, 'Xã Nam Ninh', 682),
    (25180, 'Thị trấn Phước Cát ', 682),
    (25183, 'Xã Đức Phổ', 682),
    (25189, 'Xã Quảng Ngãi', 682),
    (25192, 'Xã Đồng Nai Thượng', 682),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (26659, 'Thị trấn Long Điền', 753),
    (26662, 'Thị trấn Long Hải', 753),
    (26668, 'Xã Tam An', 753),
    (26674, 'Xã Phước Tỉnh', 753),
    (26677, 'Xã Phước Hưng', 753),
    (26680, 'Thị trấn Đất Đỏ', 753),
    (26683, 'Xã Phước Long Thọ', 753),
    (26686, 'Xã Phước Hội', 753),
    (26689, 'Thị trấn Phước Hải', 753),
    (26695, 'Xã Long Tân', 753),
    (26698, 'Xã Láng Dài', 753),
    (26704, 'Phường Phú Mỹ', 754),
    (26707, 'Phường Tân Hoà', 754),
    (26710, 'Phường Tân Hải', 754),
    ...
    (27382, 'Phường 7', 775),
    (27385, 'Phường 10', 775),
    (27397, 'Phường Rạch Ông', 776),
    (27403, 'Phường Hưng Phú', 776),
    (27409, 'Phường 4', 776),
    (27415, 'Phường Xóm Củi', 776),
    (27418, 'Phường 5', 776),
    (27421, 'Phường 14', 776),
    (27424, 'Phường 6', 776),
    (27427, 'Phường 15', 776),
...
INSERT INTO wards (ward_id, ward_name, district_id) VALUES
    ...
    (30742, 'Phường Vĩnh Thanh Vân', 899),
