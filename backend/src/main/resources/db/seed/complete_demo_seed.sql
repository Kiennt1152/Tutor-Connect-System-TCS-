...
-- =========================================================================
(1, 'Làm sao để đăng ký tài khoản trên TCS?', 'Bạn bấm vào nút "Đăng ký" tại góc trên bên phải màn hình hoặc truy cập /register, chọn vai trò phù hợp (Học viên/Phụ huynh, Gia sư, hoặc Trung tâm gia sư), điền số điện thoại, email và mật khẩu để tạo tài khoản.', 'AUTH_PROFILE', 1, 1),
(2, 'Làm sao đăng nhập tài khoản TCS?', 'Truy cập trang /login, nhập email hoặc số điện thoại kèm mật khẩu đã đăng ký. Bạn cũng có thể đăng nhập nhanh qua Google hoặc yêu cầu mã đăng nhập OTP.', 'AUTH_PROFILE', 2, 1),
(3, 'Tôi quên mật khẩu thì lấy lại thế nào?', 'Tại màn hình đăng nhập /login, bạn nhấn vào liên kết "Quên mật khẩu?" hoặc truy cập /forgot-password, nhập email đăng ký để nhận liên kết và mã xác thực đặt lại mật khẩu mới.', 'AUTH_PROFILE', 3, 1),
...
(5, 'Tài khoản bị khóa vì lý do gì và mở lại ra sao?', 'Tài khoản có thể bị khóa tạm thời nếu nhập sai mật khẩu quá 5 lần liên tiếp hoặc có dấu hiệu vi phạm chính sách sàn. Bạn vui lòng tạo phiếu hỗ trợ tại /support/tickets để được mở khóa.', 'AUTH_PROFILE', 5, 1),
(6, 'Làm sao để đổi mật khẩu tài khoản?', 'Sau khi đăng nhập, vào mục Cài đặt tài khoản trong Hồ sơ cá nhân (/profile), chọn "Đổi mật khẩu", nhập mật khẩu hiện tại và mật khẩu mới để cập nhật.', 'AUTH_PROFILE', 6, 1),
(7, 'Cập nhật thông tin hồ sơ cá nhân ở đâu?', 'Bạn truy cập mục Hồ sơ cá nhân tại /profile để chỉnh sửa họ tên, số điện thoại, địa chỉ, ảnh đại diện và thông tin liên hệ.', 'AUTH_PROFILE', 7, 1),
(8, 'Cách tải ảnh đại diện avatar chất lượng cao?', 'Trong trang Hồ sơ (/profile), nhấn vào biểu tượng máy ảnh trên khung ảnh đại diện, chọn tệp ảnh có định dạng PNG hoặc JPG dung lượng dưới 5MB để tải lên.', 'AUTH_PROFILE', 8, 1),
(9, 'Quét căn cước công dân CCCD tự động như thế nào?', 'Hệ thống TCS hỗ trợ công nghệ OCR tự động nhận diện thông tin từ ảnh chụp 2 mặt CCCD trong mục xác minh hồ sơ tại /profile giúp bạn không cần nhập liệu thủ công.', 'AUTH_PROFILE', 9, 1),
(10, 'Tạo hồ sơ con học viên (Child Profile) để làm gì?', 'Phụ huynh có thể tạo nhiều hồ sơ con dưới một tài khoản quản lý tại /profile để theo dõi lộ trình học tập, lịch học và điểm danh riêng biệt cho từng người con.', 'AUTH_PROFILE', 10, 1),
...
(12, 'Gia sư cập nhật kinh nghiệm giảng dạy ở đâu?', 'Gia sư vào mục /profile, chọn tab "Kinh nghiệm & Chuyên môn" để thêm quá trình công tác, các trường đại học đã tốt nghiệp và giải thưởng thành tích.', 'AUTH_PROFILE', 12, 1),
(13, 'Cập nhật lịch rảnh của gia sư thế nào?', 'Gia sư vào mục /profile hoặc /tutor/schedule, tích chọn các khung giờ rảnh trong tuần để phụ huynh dễ dàng đối chiếu và đặt lịch học phù hợp.', 'AUTH_PROFILE', 13, 1),
...
(16, 'Làm sao để xóa hoặc đóng tài khoản TCS?', 'Nếu không còn nhu cầu sử dụng, bạn có thể gửi yêu cầu vô hiệu hóa tài khoản trong mục Cài đặt quyền riêng tư hoặc liên hệ /support/tickets.', 'AUTH_PROFILE', 16, 1),
...
(18, 'Phiên đăng nhập hết hạn thì phải làm sao?', 'Hệ thống tự động đăng xuất sau một khoảng thời gian không hoạt động để bảo vệ tài khoản. Bạn chỉ cần đăng nhập lại tại /login để tiếp tục làm việc.', 'AUTH_PROFILE', 18, 1),
...
(20, 'Làm sao thay đổi số điện thoại nhận thông báo?', 'Bạn vào mục /profile, chọn Chỉnh sửa thông tin liên hệ, nhập số điện thoại mới và xác thực bằng mã OTP được gửi về số đó.', 'AUTH_PROFILE', 20, 1),

-- =========================================================================
-- 2. VERIFICATION (21 to 35)
-- =========================================================================
(21, 'Quy trình xác minh hồ sơ gia sư diễn ra thế nào?', 'Gia sư tải lên ảnh chụp 2 mặt CCCD, bằng cử nhân/thẻ sinh viên và chứng chỉ liên quan tại /profile. Quản trị viên TCS sẽ đối soát và phê duyệt trong vòng 24–48 giờ.', 'VERIFICATION', 21, 1),
...
(25, 'Kiểm tra trạng thái duyệt hồ sơ ở đâu?', 'Bạn vào mục /profile để xem huy hiệu trạng thái: "Chờ duyệt (PENDING)", "Đã xác minh (APPROVED)", hoặc "Từ chối (REJECTED)" kèm lý do chi tiết.', 'VERIFICATION', 25, 1),
...
(27, 'Làm sao để nộp lại giấy tờ khi bị từ chối xác minh?', 'Tại mục /profile, bấm vào nút "Cập nhật giấy tờ", chụp lại ảnh rõ nét theo đúng hướng dẫn và nhấn "Gửi duyệt lại".', 'VERIFICATION', 27, 1),
...
-- =========================================================================
(36, 'Làm sao để tìm gia sư phù hợp trên TCS?', 'Truy cập mục /tim-gia-su, sử dụng bộ lọc môn học, khối lớp, khu vực (quận/huyện), hình thức dạy (Online/Tại nhà) và mức học phí để chọn gia sư ưng ý.', 'MARKETPLACE', 36, 1),
(37, 'Làm sao để đăng bài tìm gia sư (Tạo lớp học)?', 'Học viên hoặc phụ huynh vào mục /tao-lop, điền đầy đủ môn học, lớp, địa chỉ học, thời gian rảnh và mức thù lao dự kiến rồi bấm "Đăng yêu cầu".', 'MARKETPLACE', 37, 1),
(38, 'Tìm lớp học đang tuyển gia sư ở đâu?', 'Gia sư truy cập mục /lop-hoc để xem danh sách toàn bộ các lớp đang ở trạng thái OPEN, xem yêu cầu học viên và nộp đơn ứng tuyển.', 'MARKETPLACE', 38, 1),
(39, 'Gia sư ứng tuyển lớp học như thế nào?', 'Tại trang chi tiết lớp học /lop-hoc/{id}, gia sư bấm nút "Ứng tuyển", nhập mức học phí đề xuất kèm lời giới thiệu bản thân rồi gửi phụ huynh xem xét.', 'MARKETPLACE', 39, 1),
...
(46, 'Tìm gia sư luyện thi vào lớp 10 ở đâu?', 'Tại trang /tim-gia-su, chọn khối lớp "Lớp 9", môn Toán/Văn/Anh và chọn mục tiêu "Luyện thi vào 10" trong bộ lọc chuyên môn.', 'MARKETPLACE', 46, 1),
(47, 'Tìm gia sư luyện thi Đại học khối A, B, C, D1 thế nào?', 'Tại /tim-gia-su, chọn khối lớp "Lớp 12" kèm các môn tổ hợp như Toán - Lý - Hóa, Toán - Hóa - Sinh, hoặc Toán - Văn - Anh để tìm gia sư chuyên ban.', 'MARKETPLACE', 47, 1),
(48, 'Tìm gia sư dạy Tiếng Anh giao tiếp cho người đi làm?', 'Chọn môn "Tiếng Anh", cấp độ "Người đi làm / Giao tiếp" tại /tim-gia-su để lọc các gia sư có chứng chỉ IELTS và kinh nghiệm giảng dạy công sở.', 'MARKETPLACE', 48, 1),
...
(50, 'Sau khi đăng lớp bao lâu thì có gia sư ứng tuyển?', 'Thông thường chỉ sau 15–60 phút đăng lớp tại /tao-lop, hệ thống sẽ tự động thông báo đến các gia sư phù hợp trong khu vực để nộp hồ sơ.', 'MARKETPLACE', 50, 1),
...
(55, 'Làm sao xem danh sách các gia sư được đánh giá cao nhất?', 'Tại /tim-gia-su, bạn chọn sắp xếp theo "Điểm đánh giá cao nhất" hoặc "Số lượng đánh giá nhiều nhất" để xem top gia sư uy tín.', 'MARKETPLACE', 55, 1),
(56, 'Có thể thuê gia sư dạy nhóm từ 2–5 học sinh không?', 'Có, phụ huynh có thể tạo bài đăng lớp nhóm tại /tao-lop và ghi rõ số lượng học sinh để gia sư chuẩn bị giáo án phù hợp.', 'MARKETPLACE', 56, 1),
...
-- =========================================================================
(66, 'Xem lịch dạy của gia sư ở đâu?', 'Gia sư truy cập mục Lịch dạy tại /tutor/schedule để xem toàn bộ các ca dạy trong tuần, thời gian bắt đầu và thông tin học viên.', 'TUTOR_OPS', 66, 1),
(67, 'Điểm danh học viên sau mỗi buổi học thế nào?', 'Sau khi kết thúc buổi dạy, gia sư vào /tutor/classes, chọn buổi học tương ứng và bấm "Điểm danh" kèm nội dung bài đã học.', 'TUTOR_OPS', 67, 1),
...
(70, 'Yêu cầu gia sư dạy thay (Substitute) hoạt động ra sao?', 'Nếu bận việc đột xuất dài ngày, gia sư có thể tạo yêu cầu người dạy thay tại /tutor/classes để trung tâm hoặc hệ thống hỗ trợ kết nối.', 'TUTOR_OPS', 70, 1),
...
(74, 'Quản lý danh sách tài liệu học tập cho lớp ở đâu?', 'Trong chi tiết lớp học tại /tutor/classes, gia sư có thể tải lên tệp giáo án, đề kiểm tra PDF để học viên tải về học tập.', 'TUTOR_OPS', 74, 1),
...
(77, 'Xem tổng số buổi đã dạy và số buổi còn lại ở đâu?', 'Trong bảng quản lý tiến độ lớp học tại /tutor/classes hiển thị thanh tiến độ trực quan: Số buổi hoàn thành / Tổng số buổi hợp đồng.', 'TUTOR_OPS', 77, 1),
...
(80, 'Gia sư có thể yêu cầu kết thúc lớp sớm không?', 'Nếu có lý do chính đáng không thể tiếp tục, gia sư gửi yêu cầu thanh lý hợp đồng sớm tại /tutor/classes để tiến hành tất toán số buổi đã dạy.', 'TUTOR_OPS', 80, 1),

-- =========================================================================
-- 5. CENTER_OPS (81 to 95)
-- =========================================================================
(81, 'Trung tâm gia sư quản lý danh sách giáo viên ở đâu?', 'Quản trị viên trung tâm truy cập trang /center, chọn tab "Gia sư trực thuộc" để xem danh sách, trạng thái và phân công lớp học.', 'CENTER_OPS', 81, 1),
...
(83, 'Đăng bài tuyển dụng gia sư cho trung tâm ở đâu?', 'Trung tâm vào mục Tuyển dụng tại /center/recruitment, điền yêu cầu tuyển dụng, mức lương và chế độ đãi ngộ để tiếp nhận hồ sơ.', 'CENTER_OPS', 83, 1),
...
(85, 'Hợp đồng giữa trung tâm và gia sư trực thuộc quản lý ở đâu?', 'Mục /center/contracts lưu trữ toàn bộ hợp đồng hợp tác, tỷ lệ ăn chia hoa hồng và cam kết chất lượng giữa trung tâm với gia sư.', 'CENTER_OPS', 85, 1),
(86, 'Xem báo cáo doanh thu và dòng tiền của trung tâm ở đâu?', 'Tại /center/analytics, trung tâm có thể theo dõi biểu đồ doanh thu theo tuần/tháng, số lượng lớp đang chạy và tiền hoa hồng thực nhận.', 'CENTER_OPS', 86, 1),
(87, 'Tạo lớp học nhóm cho trung tâm gia sư như thế nào?', 'Trung tâm vào /center/classes, chọn "Tạo lớp nhóm", thiết lập sĩ số tối đa, mức học phí từng học viên và phân công giáo viên đứng lớp.', 'CENTER_OPS', 87, 1),
(88, 'Xóa hoặc gỡ gia sư khỏi trung tâm thế nào?', 'Trong danh sách gia sư tại /center, chọn gia sư cần gỡ, bấm "Rút khỏi trung tâm" sau khi đã tất toán toàn bộ các lớp phụ trách.', 'CENTER_OPS', 88, 1),
...
(90, 'Thiết lập tỷ lệ hoa hồng trung tâm (Commission Rate) ở đâu?', 'Tại mục Cài đặt trung tâm /center/settings, quản trị viên có thể cấu hình tỷ lệ hoa hồng cố định hoặc linh hoạt theo từng môn học.', 'CENTER_OPS', 90, 1),
(91, 'Trung tâm có thể xuất báo cáo tài chính ra file Excel/CSV không?', 'Có, tại trang /center/analytics có nút "Xuất báo cáo CSV" để tải về dữ liệu thu chi, học phí và lương giáo viên chi tiết.', 'CENTER_OPS', 91, 1),
...
(93, 'Trung tâm gia sư có thể tạo nhiều chi nhánh không?', 'Có, trung tâm có thể quản lý nhiều cơ sở giảng dạy khác nhau trên cùng một bảng điều khiển trung tâm tại /center.', 'CENTER_OPS', 93, 1),
...
(95, 'Làm sao để đăng ký mở tài khoản Trung tâm gia sư?', 'Tại trang /register, chọn vai trò "Trung tâm gia sư (Tutor Center)", điền tên tổ chức, giấy phép kinh doanh và thông tin người đại diện.', 'CENTER_OPS', 95, 1),
...
(112, 'Làm sao liên kết tài khoản ngân hàng nhận tiền?', 'Trong mục /finance, chọn "Tài khoản ngân hàng", chọn tên ngân hàng, nhập số tài khoản và bấm Lưu để dùng cho các lần rút tiền sau.', 'FINANCE_ESCROW', 112, 1),
...
(116, 'Có thể xuất hóa đơn giá trị gia tăng (VAT) cho học phí không?', 'Doanh nghiệp hoặc phụ huynh có nhu cầu xuất hóa đơn VAT phí dịch vụ có thể gửi thông tin mã số thuế công ty tại /support/tickets.', 'FINANCE_ESCROW', 116, 1),
...
(118, 'Làm sao kiểm tra mã tham chiếu giao dịch (Transaction Ref)?', 'Trong bảng lịch sử /finance/history, mỗi giao dịch đều có mã tham chiếu duy nhất dạng TX-XXXXXX để tra cứu khi cần đối soát.', 'FINANCE_ESCROW', 118, 1),
...
(123, 'Làm sao để xem báo cáo tài chính tổng quan theo năm?', 'Tại mục /finance, chọn bộ lọc khoảng thời gian từ ngày bắt đầu đến ngày kết thúc để xem tổng hợp dòng tiền ra vào trong năm.', 'FINANCE_ESCROW', 123, 1),
...
(127, 'Làm sao để ký hợp đồng lớp học bằng mã OTP?', 'Khi nhận được thông báo hợp đồng tại /contracts, bạn đọc kỹ các điều khoản, bấm "Ký hợp đồng", nhập mã OTP 6 số gửi về điện thoại để hoàn tất.', 'CONTRACT_REVIEW', 127, 1),
(128, 'Xem danh sách các hợp đồng đã ký ở đâu?', 'Bạn truy cập mục /contracts để xem toàn bộ danh sách hợp đồng: Đang chờ ký (PENDING), Đang hiệu lực (ACTIVE), hoặc Đã kết thúc (COMPLETED).', 'CONTRACT_REVIEW', 128, 1),
(129, 'Đánh giá gia sư sau khóa học như thế nào?', 'Khi lớp học kết thúc, phụ huynh vào /classes, chọn lớp học và bấm "Đánh giá gia sư" để chấm điểm sao (1–5 sao) kèm lời nhận xét chi tiết.', 'CONTRACT_REVIEW', 129, 1),
...
(131, 'Có thể sửa hoặc xóa nhận xét đánh giá đã gửi không?', 'Đánh giá sau khi gửi sẽ hiển thị công khai để đảm bảo tính khách quan. Bạn có thể gửi yêu cầu chỉnh sửa trong vòng 7 ngày tại /support/tickets.', 'CONTRACT_REVIEW', 131, 1),
...
(133, 'Hợp đồng có thể gia hạn thêm buổi học không?', 'Có, phụ huynh và gia sư có thể tạo phụ lục gia hạn hợp đồng trực tiếp trên giao diện quản lý lớp tại /contracts.', 'CONTRACT_REVIEW', 133, 1),
...
(138, 'Tải bản in hợp đồng dạng PDF ở đâu?', 'Trong chi tiết hợp đồng tại /contracts/{id}, bấm nút "Tải PDF" để lưu về máy bản hợp đồng có đóng dấu điện tử của nền tảng TCS.', 'CONTRACT_REVIEW', 138, 1),
...
(146, 'Tải bằng chứng tranh chấp lên hệ thống như thế nào?', 'Trong giao diện tranh chấp tại /support/tickets, bạn có thể tải lên ảnh chụp màn hình tin nhắn Zalo/SMS, bản ghi âm, hoặc video buổi học (tối đa 10 tệp).', 'TRUST_SAFETY', 146, 1),
...
(150, 'Làm sao tố cáo gia sư thu tiền học phí trực tiếp từ học sinh?', 'Gửi phiếu tố cáo tại /support/tickets kèm biên lai chuyển khoản hoặc tin nhắn yêu cầu thu tiền riêng để nhận thưởng bảo vệ cộng đồng từ TCS.', 'TRUST_SAFETY', 150, 1),
(151, 'Học sinh bị quấy rối hoặc đối xử thiếu văn minh phải làm sao?', 'Hãy lập tức dừng buổi học, liên hệ hotline khẩn cấp của TCS và tạo phiếu báo cáo khẩn tại /support/tickets để được can thiệp pháp lý.', 'TRUST_SAFETY', 151, 1),
...
(153, 'Tài khoản bị khóa do nghi vấn gian lận có khiếu nại được không?', 'Bạn có quyền gửi đơn giải trình tại /support/tickets kèm chứng từ minh bạch để Ban Kiểm soát TCS xem xét mở lại tài khoản.', 'TRUST_SAFETY', 153, 1),
...
-- =========================================================================
(171, 'Bảng điều khiển quản trị Admin Dashboard nằm ở đâu?', 'Quản trị viên nền tảng truy cập trang /platform để theo dõi tổng quan các chỉ số người dùng, lớp học, doanh thu và các tác vụ cần xử lý.', 'PLATFORM_ADMIN', 171, 1),
(172, 'Xem báo cáo doanh thu và phân tích dòng tiền ở đâu?', 'Báo cáo doanh thu và tài chính chi tiết được hiển thị tại trang /platform/analytics với biểu đồ dòng tiền vào (Money In) và dòng tiền ra (Money Out).', 'PLATFORM_ADMIN', 172, 1),
(173, 'Hàng đợi duyệt xác minh hồ sơ (Verification Queue) ở đâu?', 'Admin vào mục /platform/verifications để xem danh sách gia sư và trung tâm đang chờ xét duyệt bằng cấp và căn cước công dân.', 'PLATFORM_ADMIN', 173, 1),
(174, 'Quản lý và phê duyệt yêu cầu rút tiền ở đâu?', 'Admin truy cập mục /platform/withdrawals để kiểm tra, duyệt lệnh chuyển tiền ngân hàng hoặc từ chối các yêu cầu rút tiền không hợp lệ.', 'PLATFORM_ADMIN', 174, 1),
(175, 'Quản lý các vụ tranh chấp lớp học ở đâu?', 'Admin truy cập mục /platform/disputes để xem các khiếu nại, đối soát bằng chứng từ hai bên và thực hiện phân chia tiền hoàn Escrow.', 'PLATFORM_ADMIN', 175, 1),
(176, 'Xem nhật ký hoạt động hệ thống (Audit Log) ở đâu?', 'Toàn bộ nhật ký thao tác đăng nhập, chỉnh sửa dữ liệu, phân quyền và giao dịch được ghi lại minh bạch tại /platform.', 'PLATFORM_ADMIN', 176, 1),
...
(178, 'Tính năng Reindex cơ sở tri thức AI hoạt động thế nào?', 'Admin vào /platform/analytics, bấm "Reindex AI Knowledge Base" để đồng bộ dữ liệu FAQ và tài liệu mới vào vector database của AI Assistant.', 'PLATFORM_ADMIN', 178, 1),
...
(180, 'Xuất báo cáo dữ liệu dạng file CSV ở đâu?', 'Tại các bảng quản lý người dùng, giao dịch và lớp học trên /platform đều có nút "Export CSV" để tải về báo cáo đối soát.', 'PLATFORM_ADMIN', 180, 1),
(181, 'Phân quyền tài khoản quản trị viên phụ (Moderator) thế nào?', 'Super Admin có thể cấp quyền kiểm duyệt hồ sơ, xử lý ticket hoặc xem báo cáo tài chính cho từng nhân sự tại /platform.', 'PLATFORM_ADMIN', 181, 1),
(182, 'Quản lý danh mục môn học và khối lớp tại đâu?', 'Admin có thể thêm mới hoặc ẩn các môn học, chuyên đề đào tạo trong mục Quản lý Danh mục tại trang /platform.', 'PLATFORM_ADMIN', 182, 1),
...
(184, 'Xem số lượng người dùng đang trực tuyến (Real-time Active Users)?', 'Biểu đồ người dùng thời gian thực được hiển thị trên bảng thống kê giám sát vận hành tại /platform/analytics.', 'PLATFORM_ADMIN', 184, 1),
(185, 'Khóa tài khoản vi phạm từ trang quản trị như thế nào?', 'Trong danh sách người dùng tại /platform, tìm kiếm tài khoản, chọn "Khóa tài khoản", nhập lý do và thời gian khóa.', 'PLATFORM_ADMIN', 185, 1),
(186, 'Xem tổng giá trị học phí đang ký quỹ (Total Escrow Balance)?', 'Tổng tiền học phí đang được bảo lưu an toàn trong hệ thống được cập nhật thời gian thực tại chỉ số "Escrow Balance" trên /platform.', 'PLATFORM_ADMIN', 186, 1),
(187, 'Theo dõi tỷ lệ hoàn thành lớp học (Completion Rate)?', 'Tỷ lệ lớp học hoàn tất thành công trên tổng số lớp mở được biểu diễn dạng biểu đồ hình tròn tại /platform/analytics.', 'PLATFORM_ADMIN', 187, 1),
...
(189, 'Kiểm tra độ chính xác và phản hồi của AI Assistant?', 'Admin theo dõi tỷ lệ phân loại Intent đúng, số lượt người dùng đánh giá câu trả lời hữu ích tại tab Giám sát AI trên /platform/analytics.', 'PLATFORM_ADMIN', 189, 1),
...
(191, 'Xem danh sách các gia sư có điểm uy tín thấp cần kiểm tra?', 'Bộ lọc tại /platform/verifications cho phép lọc các gia sư có điểm đánh giá dưới 3.5 sao để bộ phận CSKH liên hệ hỗ trợ.', 'PLATFORM_ADMIN', 191, 1),
(192, 'Quản lý và cập nhật nội dung các bài viết FAQ ở đâu?', 'Admin có thể thêm mới, sửa đổi hoặc xóa các bài hỏi đáp tri thức tại mục Quản lý FAQ trên trang /platform.', 'PLATFORM_ADMIN', 192, 1),
(193, 'Quy trình xử lý hoàn tiền thủ công cho học viên?', 'Trong trường hợp đặc biệt, Admin có thể phê duyệt lệnh hoàn tiền trực tiếp từ tài khoản Escrow về ví học viên tại /platform/disputes.', 'PLATFORM_ADMIN', 193, 1),
...
(195, 'Theo dõi thời gian phản hồi trung bình của máy chủ (Server Latency)?', 'Chỉ số sức khỏe hạ tầng hệ thống, thời gian phản hồi API và mức tải CPU được giám sát liên tục tại /platform.', 'PLATFORM_ADMIN', 195, 1),
...
(198, 'Trung tâm trợ giúp và các kênh liên hệ hỗ trợ TCS?', 'Bạn có thể tìm câu trả lời tại /help, tạo phiếu hỗ trợ tại /support/tickets, gửi email về support@tcs.edu.vn hoặc gọi hotline 1900-XXXX.', 'GENERAL', 198, 1),
